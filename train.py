...
def preprocess():
    ...
    # Load data
    print("Loading data...")
    x_text, y, embedding_name, embedding_dimension = load_data_and_labels()
    ...
    print("Train/Dev split: {:d}/{:d}".format(len(y_train), len(y_dev)))
    return x_train, y_train, vocab_processor, x_dev, y_dev, embedding_name, embedding_dimension

def train(x_train, y_train, vocab_processor, x_dev, y_dev, embedding_name, embedding_dimension):
    # Training
    # ==================================================
    ...
    with tf.Graph().as_default():
        ...
        with sess.as_default():
            ...
            if FLAGS.enable_word_embeddings and cfg is not None and cfg['word_embeddings']['default'] is not None:
...
def main(argv=None):
    x_train, y_train, vocab_processor, x_dev, y_dev, embedding_name, embedding_dimension = preprocess()
